...
*note that I have a parameter "MaptTline1" to represent this as well
...
*$call GDXXRW input_gtepja_2019-02-06.xlsx @gtepinput.txt
*$GDXIN input_gtepja_2019-02-06.gdx

*$CALL GDXXRW input_gtepja_2019-02-21.xlsx @gtepinput.txt
*$GDXIN input_gtepja_2019-02-21.gdx

*$CALL GDXXRW input_gtepja_2019-02-28.xlsx @gtepinput.txt
*$GDXIN input_gtepja_2019-02-28.gdx

*$CALL GDXXRW input_gtepja_2019-04-10.xlsx @gtepinput.txt
*$GDXIN input_gtepja_2019-04-10.gdx

*$CALL GDXXRW input_gtepja_DisAggTest_2019-08-28.xlsx @gtepinput.txt
*$GDXIN input_gtepja_DisAggTest_2019-08-28.gdx

*$CALL GDXXRW input_gtepja_DisAggTest_2019-10-09.xlsx @gtepinput.txt
*$GDXIN input_gtepja_DisAggTest_2019-10-09.gdx

*$CALL GDXXRW input_gtepja_DisAggTest_2019-10-14.xlsx @gtepinput.txt
*$GDXIN input_gtepja_DisAggTest_2019-10-14.gdx

*$CALL GDXXRW input_gtepja_Final_2019-10-24.xlsx @gtepinput.txt
*$GDXIN input_gtepja_Final_2019-10-24.gdx

*$CALL GDXXRW input_gtepja_Final_2020-01-21.xlsx @gtepinput.txt
*$GDXIN input_gtepja_Final_2020-01-21.gdx

*$CALL GDXXRW input_gtepja_Final_2020-02-06_disc1195.xlsx @gtepinput.txt
*$GDXIN input_gtepja_Final_2020-02-06_disc1195.gdx
...
*-----------------------------------
*$ONTEXT
Execute_unload "Output_GTEPJA_all_CalibrationFullModel_HighFuelPrice.gdx"  opcostx,TotGen,GSnSSD,GHydro,GGT,GCC,NEOX17,JPSCoGen, IPPGen, capfactor, CapFactor2017, CapFactorDiff
Execute "gdxxrw.exe Output_GTEPJA_all_CalibrationFullModel_HighFuelPrice.gdx par=OpCostX rng=OpCostX!"
Execute "gdxxrw.exe Output_GTEPJA_all_CalibrationFullModel_HighFuelPrice.gdx Par=TotGen rng=CompareTotGen!"
Execute "gdxxrw.exe Output_GTEPJA_all_CalibrationFullModel_HighFuelPrice.gdx Par=GSnSSD rng=CompareSnSSD!"
Execute "gdxxrw.exe Output_GTEPJA_all_CalibrationFullModel_HighFuelPrice.gdx Par=GHydro rng=CompareJPSHydro!"
Execute "gdxxrw.exe Output_GTEPJA_all_CalibrationFullModel_HighFuelPrice.gdx Par=GGT rng=CompareJPSGGT!"
Execute "gdxxrw.exe Output_GTEPJA_all_CalibrationFullModel_HighFuelPrice.gdx Par=GCC rng=CompareJPSCC!"
Execute "gdxxrw.exe Output_GTEPJA_all_CalibrationFullModel_HighFuelPrice.gdx par=NEOX17 rng=Net_Output_Renewable!"
Execute "gdxxrw.exe Output_GTEPJA_all_CalibrationFullModel_HighFuelPrice.gdx par=JPSCoGen rng=CompareJPSCo!"
Execute "gdxxrw.exe Output_GTEPJA_all_CalibrationFullModel_HighFuelPrice.gdx par=IPPGen rng=CompareIPPs!"
Execute "gdxxrw.exe Output_GTEPJA_all_CalibrationFullModel_HighFuelPrice.gdx par=CapFactor2017 rng=SCapFactor2017!"
Execute "gdxxrw.exe Output_GTEPJA_all_CalibrationFullModel_HighFuelPrice.gdx par=CapFactorDiff rng=SCapFactorDiff!"
*$OFFTEXT
;
*------------------------------------------------------------------------
...
*------------------------------------------------------------------------
*$ONTEXT
Execute_unload "Output_GTEPJA_all_simkvl_HighFuelPrice.gdx" stotcost,totcosty, LCOE, powerflow.m, powerflowshare,theta.l,UE.l,uegwh,ueshare,u.l, opcost, SInvcostPlant, SInvcostTline, SBuildplant, SbuildTline,Annual_Generation,GenPortfolio,GenPortfolioShare,capfactor
Execute "gdxxrw.exe Output_GTEPJA_all_simkvl_HighFuelPrice.gdx par=stotcost rng=STotalCost!"
Execute "gdxxrw.exe Output_GTEPJA_all_simkvl_HighFuelPrice.gdx par=TotCosty rng=yrlyTotCost!"
Execute "gdxxrw.exe Output_GTEPJA_all_simkvl_HighFuelPrice.gdx par=LCOE rng=LCOE_centskWh!"
Execute "gdxxrw.exe Output_GTEPJA_all_simkvl_HighFuelPrice.gdx var=powerflow.m rng=PowerFlowmarginal!"
Execute "gdxxrw.exe Output_GTEPJA_all_simkvl_HighFuelPrice.gdx par=powerflowshare rng=PowerFlowShare!"
Execute "gdxxrw.exe Output_GTEPJA_all_simkvl_HighFuelPrice.gdx var=theta.l rng=Theta!"
Execute "gdxxrw.exe Output_GTEPJA_all_simkvl_HighFuelPrice.gdx var=UE.l rng=Unserved_EnergyMW!"
Execute "gdxxrw.exe Output_GTEPJA_all_simkvl_HighFuelPrice.gdx Par=UEGWh rng=Unserved_EnergyGWh!"
Execute "gdxxrw.exe Output_GTEPJA_all_simkvl_HighFuelPrice.gdx Par=UEshare rng=Percent_Unmet_Demand!"
Execute "gdxxrw.exe Output_GTEPJA_all_simkvl_HighFuelPrice.gdx var=u.l rng=U!"
Execute "gdxxrw.exe Output_GTEPJA_all_simkvl_HighFuelPrice.gdx par=opcost rng=OpCost_USDM!"
Execute "gdxxrw.exe Output_GTEPJA_all_simkvl_HighFuelPrice.gdx par=SInvcostPlant rng=InvCostPlant!"
Execute "gdxxrw.exe Output_GTEPJA_all_simkvl_HighFuelPrice.gdx par=SInvcostTline rng=InvCostTline!"
Execute "gdxxrw.exe Output_GTEPJA_all_simkvl_HighFuelPrice.gdx par=SBuildPlant rng=BuildPlant!"
Execute "gdxxrw.exe Output_GTEPJA_all_simkvl_HighFuelPrice.gdx par=SBuildTline rng=BuildTline!"
Execute "gdxxrw.exe Output_GTEPJA_all_simkvl_HighFuelPrice.gdx par=Annual_Generation rng=Generation_GWh!"
Execute "gdxxrw.exe Output_GTEPJA_all_simkvl_HighFuelPrice.gdx par=GenPortfolio rng=GenPortfolio_GWh!"
Execute "gdxxrw.exe Output_GTEPJA_all_simkvl_HighFuelPrice.gdx par=GenPortfolioShare rng=GenPortfolioShare!"
Execute "gdxxrw.exe Output_GTEPJA_all_simkvl_HighFuelPrice.gdx par=CapFactor rng=SCapFator!"
*$OFFTEXT
;
...
GTEPJA_Transportation.resLim=604800;
...
*------------------------------------------------------------------------
*$ONTEXT
Execute_unload "Output_GTEPJA_all_nokvl_HighFuelPrice.gdx" stotcost,totcosty, LCOE, powerflow.m,theta.l, opcost, SInvcostPlant, SInvcostTline, SBuildplant, SbuildTline,Annual_Generation,GenPortfolio,GenPortfolioShare,capfactor
Execute "gdxxrw.exe Output_GTEPJA_all_nokvl_HighFuelPrice.gdx par=stotcost rng=STotalCost!"
Execute "gdxxrw.exe Output_GTEPJA_all_nokvl_HighFuelPrice.gdx par=TotCosty rng=yrlyTotCost!"
Execute "gdxxrw.exe Output_GTEPJA_all_nokvl_HighFuelPrice.gdx par=LCOE rng=LCOE_centskWh!"
Execute "gdxxrw.exe Output_GTEPJA_all_nokvl_HighFuelPrice.gdx var=powerflow.m rng=PowerFlowmarginal!"
Execute "gdxxrw.exe Output_GTEPJA_all_nokvl_HighFuelPrice.gdx var=theta.l rng=Theta!"
Execute "gdxxrw.exe Output_GTEPJA_all_nokvl_HighFuelPrice.gdx par=opcost rng=OpCost_USDM!"
Execute "gdxxrw.exe Output_GTEPJA_all_nokvl_HighFuelPrice.gdx par=SInvcostPlant rng=InvCostPlant!"
Execute "gdxxrw.exe Output_GTEPJA_all_nokvl_HighFuelPrice.gdx par=SInvcostTline rng=InvCostTline!"
Execute "gdxxrw.exe Output_GTEPJA_all_nokvl_HighFuelPrice.gdx par=SBuildPlant rng=BuildPlant!"
Execute "gdxxrw.exe Output_GTEPJA_all_nokvl_HighFuelPrice.gdx par=SBuildTline rng=BuildTline!"
Execute "gdxxrw.exe Output_GTEPJA_all_nokvl_HighFuelPrice.gdx par=Annual_Generation rng=Generation_GWh!"
Execute "gdxxrw.exe Output_GTEPJA_all_nokvl_HighFuelPrice.gdx par=GenPortfolio rng=GenPortfolio_GWh!"
Execute "gdxxrw.exe Output_GTEPJA_all_nokvl_HighFuelPrice.gdx par=GenPortfolioShare rng=GenPortfolioShare!"
Execute "gdxxrw.exe Output_GTEPJA_all_nokvl_HighFuelPrice.gdx par=CapFactor rng=SCapFator!"
*$OFFTEXT
;
...
Execute_unload "Output_GTEPJA_all_seq_kvl_pt1_HighFuelPrice.gdx"  buildPlant.l, BuildTLine.l
Execute "gdxxrw.exe Output_GTEPJA_all_seq_kvl_pt1_HighFuelPrice.gdx var=BuildPlant.l rng=BuildPlant!"
Execute "gdxxrw.exe Output_GTEPJA_all_seq_kvl_pt1_HighFuelPrice.gdx var=BuildTLine.l rng=BuildTLine!"
...
BuildTline.lo(year,CTline)=0;
BuildTline.up(year,CTline)=1;
...
SBuildPlant(year,cplant,tec,'seq_KVL_b')=BuildPlant.l(year,CPlant,tec);
...
*------------------------------------------------------------------------
*$ONTEXT
Execute_unload "Output_GTEPJA_all_seqkvlCombined_HighFuelPrice.gdx" stotcost,totcosty, LCOE, powerflow.m, opcost, SInvcostPlant, SInvcostTline, SBuildplant, SbuildTline,Annual_Generation,GenPortfolio,GenPortfolioShare,capfactor
Execute "gdxxrw.exe Output_GTEPJA_all_seqkvlCombined_HighFuelPrice.gdx par=stotcost rng=STotalCost!"
Execute "gdxxrw.exe Output_GTEPJA_all_seqkvlCombined_HighFuelPrice.gdx par=TotCosty rng=yrlyTotCost!"
Execute "gdxxrw.exe Output_GTEPJA_all_seqkvlCombined_HighFuelPrice.gdx par=LCOE rng=LCOE_centskWh!"
Execute "gdxxrw.exe Output_GTEPJA_all_seqkvlCombined_HighFuelPrice.gdx var=powerflow.m rng=PowerFlowmarginal!"
Execute "gdxxrw.exe Output_GTEPJA_all_seqkvlCombined_HighFuelPrice.gdx par=opcost rng=OpCost_USDM!"
Execute "gdxxrw.exe Output_GTEPJA_all_seqkvlCombined_HighFuelPrice.gdx par=SInvcostPlant rng=InvCostPlant!"
Execute "gdxxrw.exe Output_GTEPJA_all_seqkvlCombined_HighFuelPrice.gdx par=SInvcostTline rng=InvCostTline!"
Execute "gdxxrw.exe Output_GTEPJA_all_seqkvlCombined_HighFuelPrice.gdx par=SBuildPlant rng=BuildPlant!"
Execute "gdxxrw.exe Output_GTEPJA_all_seqkvlCombined_HighFuelPrice.gdx par=SBuildTline rng=BuildTline!"
Execute "gdxxrw.exe Output_GTEPJA_all_seqkvlCombined_HighFuelPrice.gdx par=Annual_Generation rng=Generation_GWh!"
Execute "gdxxrw.exe Output_GTEPJA_all_seqkvlCombined_HighFuelPrice.gdx par=GenPortfolio rng=GenPortfolio_GWh!"
Execute "gdxxrw.exe Output_GTEPJA_all_seqkvlCombined_HighFuelPrice.gdx par=GenPortfolioShare rng=GenPortfolioShare!"
Execute "gdxxrw.exe Output_GTEPJA_all_seqkvlCombined_HighFuelPrice.gdx par=CapFactor rng=SCapFator!"
*$OFFTEXT
