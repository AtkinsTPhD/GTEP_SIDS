...
*-----------------------------------
*$ONTEXT
Execute_unload "Output_GTEPJA_all_CalibrationFullModel_LowFuelPrice.gdx"  opcostx,TotGen,GSnSSD,GHydro,GGT,GCC,NEOX17,JPSCoGen, IPPGen, capfactor, CapFactor2017, CapFactorDiff
Execute "gdxxrw.exe Output_GTEPJA_all_CalibrationFullModel_LowFuelPrice.gdx par=OpCostX rng=OpCostX!"
Execute "gdxxrw.exe Output_GTEPJA_all_CalibrationFullModel_LowFuelPrice.gdx Par=TotGen rng=CompareTotGen!"
Execute "gdxxrw.exe Output_GTEPJA_all_CalibrationFullModel_LowFuelPrice.gdx Par=GSnSSD rng=CompareSnSSD!"
Execute "gdxxrw.exe Output_GTEPJA_all_CalibrationFullModel_LowFuelPrice.gdx Par=GHydro rng=CompareJPSHydro!"
Execute "gdxxrw.exe Output_GTEPJA_all_CalibrationFullModel_LowFuelPrice.gdx Par=GGT rng=CompareJPSGGT!"
Execute "gdxxrw.exe Output_GTEPJA_all_CalibrationFullModel_LowFuelPrice.gdx Par=GCC rng=CompareJPSCC!"
Execute "gdxxrw.exe Output_GTEPJA_all_CalibrationFullModel_LowFuelPrice.gdx par=NEOX17 rng=Net_Output_Renewable!"
Execute "gdxxrw.exe Output_GTEPJA_all_CalibrationFullModel_LowFuelPrice.gdx par=JPSCoGen rng=CompareJPSCo!"
Execute "gdxxrw.exe Output_GTEPJA_all_CalibrationFullModel_LowFuelPrice.gdx par=IPPGen rng=CompareIPPs!"
Execute "gdxxrw.exe Output_GTEPJA_all_CalibrationFullModel_LowFuelPrice.gdx par=CapFactor2017 rng=SCapFactor2017!"
Execute "gdxxrw.exe Output_GTEPJA_all_CalibrationFullModel_LowFuelPrice.gdx par=CapFactorDiff rng=SCapFactorDiff!"
*$OFFTEXT
;
*------------------------------------------------------------------------
...
*------------------------------------------------------------------------
*$ONTEXT
Execute_unload "Output_GTEPJA_all_simkvl_LowFuelPrice.gdx" stotcost,totcosty, LCOE, powerflow.m, powerflowshare,theta.l,UE.l,uegwh,ueshare,u.l, opcost, SInvcostPlant, SInvcostTline, SBuildplant, SbuildTline,Annual_Generation,GenPortfolio,GenPortfolioShare,capfactor
Execute "gdxxrw.exe Output_GTEPJA_all_simkvl_LowFuelPrice.gdx par=stotcost rng=STotalCost!"
Execute "gdxxrw.exe Output_GTEPJA_all_simkvl_LowFuelPrice.gdx par=TotCosty rng=yrlyTotCost!"
Execute "gdxxrw.exe Output_GTEPJA_all_simkvl_LowFuelPrice.gdx par=LCOE rng=LCOE_centskWh!"
Execute "gdxxrw.exe Output_GTEPJA_all_simkvl_LowFuelPrice.gdx var=powerflow.m rng=PowerFlowmarginal!"
Execute "gdxxrw.exe Output_GTEPJA_all_simkvl_LowFuelPrice.gdx par=powerflowshare rng=PowerFlowShare!"
Execute "gdxxrw.exe Output_GTEPJA_all_simkvl_LowFuelPrice.gdx var=theta.l rng=Theta!"
Execute "gdxxrw.exe Output_GTEPJA_all_simkvl_LowFuelPrice.gdx var=UE.l rng=Unserved_EnergyMW!"
Execute "gdxxrw.exe Output_GTEPJA_all_simkvl_LowFuelPrice.gdx Par=UEGWh rng=Unserved_EnergyGWh!"
Execute "gdxxrw.exe Output_GTEPJA_all_simkvl_LowFuelPrice.gdx Par=UEshare rng=Percent_Unmet_Demand!"
Execute "gdxxrw.exe Output_GTEPJA_all_simkvl_LowFuelPrice.gdx var=u.l rng=U!"
Execute "gdxxrw.exe Output_GTEPJA_all_simkvl_LowFuelPrice.gdx par=opcost rng=OpCost_USDM!"
Execute "gdxxrw.exe Output_GTEPJA_all_simkvl_LowFuelPrice.gdx par=SInvcostPlant rng=InvCostPlant!"
Execute "gdxxrw.exe Output_GTEPJA_all_simkvl_LowFuelPrice.gdx par=SInvcostTline rng=InvCostTline!"
Execute "gdxxrw.exe Output_GTEPJA_all_simkvl_LowFuelPrice.gdx par=SBuildPlant rng=BuildPlant!"
Execute "gdxxrw.exe Output_GTEPJA_all_simkvl_LowFuelPrice.gdx par=SBuildTline rng=BuildTline!"
Execute "gdxxrw.exe Output_GTEPJA_all_simkvl_LowFuelPrice.gdx par=Annual_Generation rng=Generation_GWh!"
Execute "gdxxrw.exe Output_GTEPJA_all_simkvl_LowFuelPrice.gdx par=GenPortfolio rng=GenPortfolio_GWh!"
Execute "gdxxrw.exe Output_GTEPJA_all_simkvl_LowFuelPrice.gdx par=GenPortfolioShare rng=GenPortfolioShare!"
Execute "gdxxrw.exe Output_GTEPJA_all_simkvl_LowFuelPrice.gdx par=CapFactor rng=SCapFator!"
*$OFFTEXT
;
...
*------------------------------------------------------------------------
*$ONTEXT
Execute_unload "Output_GTEPJA_all_nokvl_LowFuelPrice.gdx" stotcost,totcosty, LCOE, powerflow.m,theta.l, opcost, SInvcostPlant, SInvcostTline, SBuildplant, SbuildTline,Annual_Generation,GenPortfolio,GenPortfolioShare,capfactor
Execute "gdxxrw.exe Output_GTEPJA_all_nokvl_LowFuelPrice.gdx par=stotcost rng=STotalCost!"
Execute "gdxxrw.exe Output_GTEPJA_all_nokvl_LowFuelPrice.gdx par=TotCosty rng=yrlyTotCost!"
Execute "gdxxrw.exe Output_GTEPJA_all_nokvl_LowFuelPrice.gdx par=LCOE rng=LCOE_centskWh!"
Execute "gdxxrw.exe Output_GTEPJA_all_nokvl_LowFuelPrice.gdx var=powerflow.m rng=PowerFlowmarginal!"
Execute "gdxxrw.exe Output_GTEPJA_all_nokvl_LowFuelPrice.gdx var=theta.l rng=Theta!"
Execute "gdxxrw.exe Output_GTEPJA_all_nokvl_LowFuelPrice.gdx par=opcost rng=OpCost_USDM!"
Execute "gdxxrw.exe Output_GTEPJA_all_nokvl_LowFuelPrice.gdx par=SInvcostPlant rng=InvCostPlant!"
Execute "gdxxrw.exe Output_GTEPJA_all_nokvl_LowFuelPrice.gdx par=SInvcostTline rng=InvCostTline!"
Execute "gdxxrw.exe Output_GTEPJA_all_nokvl_LowFuelPrice.gdx par=SBuildPlant rng=BuildPlant!"
Execute "gdxxrw.exe Output_GTEPJA_all_nokvl_LowFuelPrice.gdx par=SBuildTline rng=BuildTline!"
Execute "gdxxrw.exe Output_GTEPJA_all_nokvl_LowFuelPrice.gdx par=Annual_Generation rng=Generation_GWh!"
Execute "gdxxrw.exe Output_GTEPJA_all_nokvl_LowFuelPrice.gdx par=GenPortfolio rng=GenPortfolio_GWh!"
Execute "gdxxrw.exe Output_GTEPJA_all_nokvl_LowFuelPrice.gdx par=GenPortfolioShare rng=GenPortfolioShare!"
Execute "gdxxrw.exe Output_GTEPJA_all_nokvl_LowFuelPrice.gdx par=CapFactor rng=SCapFator!"
*$OFFTEXT
;
...
Execute_unload "Output_GTEPJA_all_seq_kvl_pt1_LowFuelPrice.gdx"  buildPlant.l, BuildTLine.l
Execute "gdxxrw.exe Output_GTEPJA_all_seq_kvl_pt1_LowFuelPrice.gdx var=BuildPlant.l rng=BuildPlant!"
Execute "gdxxrw.exe Output_GTEPJA_all_seq_kvl_pt1_LowFuelPrice.gdx var=BuildTLine.l rng=BuildTLine!"
...
*------------------------------------------------------------------------
*$ONTEXT
Execute_unload "Output_GTEPJA_all_seqkvlCombined_LowFuelPrice.gdx" stotcost,totcosty, LCOE, powerflow.m, opcost, SInvcostPlant, SInvcostTline, SBuildplant, SbuildTline,Annual_Generation,GenPortfolio,GenPortfolioShare,capfactor
Execute "gdxxrw.exe Output_GTEPJA_all_seqkvlCombined_LowFuelPrice.gdx par=stotcost rng=STotalCost!"
Execute "gdxxrw.exe Output_GTEPJA_all_seqkvlCombined_LowFuelPrice.gdx par=TotCosty rng=yrlyTotCost!"
Execute "gdxxrw.exe Output_GTEPJA_all_seqkvlCombined_LowFuelPrice.gdx par=LCOE rng=LCOE_centskWh!"
Execute "gdxxrw.exe Output_GTEPJA_all_seqkvlCombined_LowFuelPrice.gdx var=powerflow.m rng=PowerFlowmarginal!"
Execute "gdxxrw.exe Output_GTEPJA_all_seqkvlCombined_LowFuelPrice.gdx par=opcost rng=OpCost_USDM!"
Execute "gdxxrw.exe Output_GTEPJA_all_seqkvlCombined_LowFuelPrice.gdx par=SInvcostPlant rng=InvCostPlant!"
Execute "gdxxrw.exe Output_GTEPJA_all_seqkvlCombined_LowFuelPrice.gdx par=SInvcostTline rng=InvCostTline!"
Execute "gdxxrw.exe Output_GTEPJA_all_seqkvlCombined_LowFuelPrice.gdx par=SBuildPlant rng=BuildPlant!"
Execute "gdxxrw.exe Output_GTEPJA_all_seqkvlCombined_LowFuelPrice.gdx par=SBuildTline rng=BuildTline!"
Execute "gdxxrw.exe Output_GTEPJA_all_seqkvlCombined_LowFuelPrice.gdx par=Annual_Generation rng=Generation_GWh!"
Execute "gdxxrw.exe Output_GTEPJA_all_seqkvlCombined_LowFuelPrice.gdx par=GenPortfolio rng=GenPortfolio_GWh!"
Execute "gdxxrw.exe Output_GTEPJA_all_seqkvlCombined_LowFuelPrice.gdx par=GenPortfolioShare rng=GenPortfolioShare!"
Execute "gdxxrw.exe Output_GTEPJA_all_seqkvlCombined_LowFuelPrice.gdx par=CapFactor rng=SCapFator!"
*$OFFTEXT
